  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
           ...
           child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween, // 🔹 pushes text left & arrow right
...
Widget _buildCategoryCard(String title) {
  return Container(
    ...
    height: 40,
    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10), // keep some padding
    decoration: BoxDecoration(
      color: Colors.white,
      borderRadius: BorderRadius.circular(20),
      border: Border.all(
